...
INSERT INTO tbl_specialist
	...
	VALUES
	('margret', 'nyguen', '384-756-2899'),
	('mary', 'fischer', '384-444-3928'), 
	('arnold', 'holden', '323-323-2895'),
	('ken', 'byesan', '384-323-3485'),
	('delmonte', 'fyedo', '768-322-3499')
;
...
CREATE TABLE tbl_species ( 
	...
	species_animalia INT NOT NULL CONSTRAINT fk_animaila_id FOREIGN KEY REFERENCES tbl_animalia(animalia_id) ON UPDATE CASCADE ON DELETE CASCADE,
